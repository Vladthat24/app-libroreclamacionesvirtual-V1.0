...
/*=============================================
 CONSULTAR BASE DE DATOS RENIEC  LIGITIMADO
 =============================================*/
$(function () {
    $('#consultarLigitimado').on('click', function () {
        var dni = $('#dniLigitimado').val();
...
//               $('#nuevoNombre').text(datos[3]+" "+datos[1]+" "+datos[2]);
                $('#nuevNombreLigitimado').val(datos[1]+" "+datos[2]+" "+datos[3]);
